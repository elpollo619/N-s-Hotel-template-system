...
| **Öffentlicher Parkplatz** | A4 hoch, mehrseitig | Wegweiser zum öffentlichen Parkplatz nebenan: Lageplan (gezeichnet, eigenes Bild **oder** swisstopo-Ausschnitt per Link — wird ins Blatt gebacken), Tarif, Bezahlen, Kennzeichen-Hinweis — eine Seite je Sprache |
